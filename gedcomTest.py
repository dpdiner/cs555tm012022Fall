...
class TestGedcom(unittest.TestCase):
    ...
    def testUserStory08(self):
        ...
        families = Team_1_Gedcom_Project.familyFunc(families, individuals)
        self.assertEqual(capturedOutput.getvalue() ,"ERROR: INDVIDUAL: US08: I3: Birthday of child is before the marriage of their parents\nERROR: INDVIDUAL: US08: I3: Birthday of child is after the divorce of their parents\n")
        sys.stdout = sys.__stdout__
    ...
    def testUserStory30(self):
        ...
        self.assertEqual(capturedOutput.getvalue() ,"#############User story 30 for list living married#################\nThe members who are living and married are:\nJezebel /Gilbert/\n")
        sys.stdout = sys.__stdout__
    ...
    def testUserStory31(self):
        ...
        self.assertEqual(capturedOutput.getvalue() ,"###########User story 31 for living single#############\nThe members who are living and single are:\nJezebel /Gilbert/\n")
        sys.stdout = sys.__stdout__
