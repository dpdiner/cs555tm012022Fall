...
Original file is located at
    https://colab.research.google.com/drive/1ogBy-X-g3ROP0lAtAohNPnmXZ9WcLiFW
"""
...
def printOutput():
    ...
    famPT.field_names = ["ID", "MARRIED", "DIVORCED", "Married Before Divorce","Marriage before death","HUSBAND ID", "HUSBAND NAME", "WIFE ID", "WIFE NAME", "CHILDREN"]
